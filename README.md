...
This repository contains a complete, from-scratch implementation of a **decoder-only GPT** language model in PyTorch featuring **Key-Value (KV) Caching** for efficient inference. It is heavily inspired by Andrej Karpathy's "nanoGPT" and "Let's build GPT" lectures.
...
You can easily modify hyperparameters in `GPT.py` at the top of the file:
